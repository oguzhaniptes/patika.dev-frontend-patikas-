...
let menuContainer = document.querySelector("#items");
...
function food(newMenu) {
  let displayMenu = newMenu.map((fd) => {
...
function selectCategory(flt) {
  selectedCategory = flt;
  if (selectedCategory === "All") {
    filteredMenu = menu;
    food(filteredMenu);
  } else {
    let newArray = menu.filter((flt) => flt.category === selectedCategory);
    food(newArray);
  }
}
